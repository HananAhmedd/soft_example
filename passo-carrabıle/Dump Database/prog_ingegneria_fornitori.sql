...
CREATE TABLE `fornitori` (
  ...
  `nome_ditta` varchar(20) DEFAULT NULL,
  `sede` varchar(20) DEFAULT 'Messina',
...
INSERT INTO `fornitori` VALUES (1,'ditta1','via napoli, 90','RC',60214,'12345678912','ditta1@email.it'),(2,'ditta2','via ugo bassi, 15','ME',98100,'57926547987','ditta2@email.it'),(3,'ditta3','via trento, 55','MI',78945,'45879320015','ditta3@email.it');

...
public class LoginForm extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Accedi a GameShop");
    ...
    private void btnAccediActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAccediActionPerformed
        String filter = "Email = \"" + eMailAddress.getText() + "\" AND Password =\"";
        filter += new String(password.getPassword()) + "\"";
        try
        {
            Globals.prepareToVerifyUser();
            User user = new User(filter); 
            Globals.closeVerifyConnection();
            if (user.getInitialized())
            {
                JOptionPane.showMessageDialog(null, "Benvenuto " + user.getNome() + " " + user.getCognome());
                Globals.setUser(user);
                this.setVisible(false);
            }
            else
                JOptionPane.showMessageDialog(null, "Nome utente o password errati. Riprovare.");
